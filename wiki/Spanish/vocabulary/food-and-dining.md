---
source: "food-and-dining"
category: "food"
level: "A1-B1"
theme: "food"
---

# Comida y Restaurantes (Spanish Food and Dining)

**Source:** [[food-and-dining]]
**Theme:** Food / Restaurant
**Level:** A1-B1 (Beginner-Intermediate)

Spanish vocabulary for restaurants, cooking, food types, dietary restrictions. Useful for travelers and food enthusiasts.
...
|---------|--------|--------|
| menú | menu | 메뉴판 |
| camarero/camarera | waiter/waitress (m/f) | 종업원 |
| cuenta | bill | 계산서 |
| propina | tip | 팁 |
| reserva | reservation | 예약 |
| pedido | order | 주문 |
| entrante | appetizer | 전채 |
| plato principal | main course | 메인 요리 |
| postre | dessert | 디저트 |
| bebida | drink | 음료 |
...
| hervir | to boil | 끓이다 |
| freír | to fry | 튀기다 |
| hornear | to bake | 굽다 (오븐) |
| asar | to grill | 구워다 |
| cocer al vapor | to steam | 찌다 |
| saltear | to sauté | 볶다 |
...
| Español | Inglés | 한국어 |
|---------|--------|--------|
| vegetariano | vegetarian | 채식주의자 |
| vegano | vegan | 비건 |
| sin gluten | gluten-free | 글루텐 프리 |
...
- España: lunch 14:00, dinner 21:00-22:30
- Latinoamérica: lunch 13:00-14:00, dinner 19:00-21:00
- Sobremesa: post-meal conversation
- Propina: included in bill (Spain), 10% extra (Latin America)
- Tapas: small Spanish dishes

## Sources

- National Spanish Academy Dictionary (RAE)
- Menu vocabulary from Spanish restaurants
