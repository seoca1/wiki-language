...
- { id: 'es_nature_039', display: 'cálido / templado', input: 'cálido / templado', meaning: 'Moderadamente caliente; acogedor; reconfortante.', level: 'A2-B1', category: 'nature', source: '[[nature-vocabulary-es]]' }
```
