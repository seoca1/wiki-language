...
Family and kinship vocabulary across the multilingual corpora: the cross-language-comparison of family-roles, kinship-relations, generational-hierarchy, and family-related-cultural-practices. This is a comparative-vocabulary-page tracking universal-themes across Korean, Japanese, English, Spanish, and Chinese.
...
- 큰 (keun) — honorific-prefix for eldest-line
...
- 春节 (Chūnjié) — family-reunion-celebration
...
- Related: `Language/wiki/{Korean,Japanese,English,Spanish,Chinese}/vocabulary/`
- Related: `Language/wiki/{Korean,Japanese,English,Spanish,Chinese}/culture/`
