# Tech & Internet — Cross-Language Comparison

**Languages**: English · Spanish · Japanese · Korean · Chinese
**Last updated**: 2026-07-19

> Digital vocabulary, social media platforms, mobile pay, internet culture, and emoji/symbol conventions.

---

## Mobile Payment Ecosystems

| Provider | English (US/UK) | Spanish | Japan | Korea | China |
|----------|-----------------|---------|-------|-------|--------|
| **Native (cashless)** | Apple Pay, Google Pay, Venmo, Zelle | Bizum (Spain), Yape (Peru) | Suica/Pasmo (transit), **PayPay**, LINE Pay, Rakuten Pay | **Samsung Pay**, **Kakao Pay**, **Naver Pay**, Toss | **WeChat Pay (微信支付)**, **Alipay (支付宝)** — near-universal |
...
**Key cultural pattern**: 
- US: Cards still primary, mobile pay growing
- Spain: Bizum for peer-to-peer
- Japan: Suica for transit (originally), now PayPay for general
- Korea: Mobile-first (Samsung Pay, Kakao Pay)
- China: **Mobile-first from 2015**; WeChat/Alipay = default; cash rare

---

## Social Media Platforms by Country

### English-Speaking West (US/UK/AU/CA)
| Platform | Status | Use |
|----------|--------|-----|
| **Facebook** | **Declining** (older users) | Family/groups/events |
| **Instagram** | Dominant for youth | Photo/video stories |
| **TikTok** | **Massive** (Gen Z) | Short videos |
| **X (Twitter)** | Niche (journalists/tech) | News/discourse |
| **Snapchat** | Niche (Gen Z only) | Disappearing messages |
| **Reddit** | Niche | Forums/discussion |
| **LinkedIn** | Professional | Networking |
| **YouTube** | Universal | Long video |
| **WhatsApp** | Universal in UK/AU | Messaging |

### Spanish-Speaking (Spain + LatAm)
| Platform | Status | Region |
|----------|--------|--------|
| **WhatsApp** | **Universal** | All |
| **Facebook** | Dominant (LatAm) | LatAm elders/family |
| **Instagram** | Dominant (youth) | All |
| **TikTok** | Growing | Youth |
| **Twitter/X** | Politically active (Spain) | Spain |
| **Telegram** | Niche | Spain |
| **LINE** | — | Spain small |

### Japan
| Platform | Status | Use |
|----------|--------|-----|
| **LINE** | **Universal** (90%+) | Messaging |
| **X (Twitter)** | **Very popular** (vs. US) | Real-time, news |
| **Instagram** | Growing | Photo stories |
| **TikTok** | Growing | Youth video |
| **Facebook** | Older/family | Family groups |
| **Mixi** | Niche | Older |
| **Ameblo** | Niche | Blogs |
| **Pixiv** | Otaku art | Art community |
| **2channel/5ch** | Anon forums | Discussion |

### Korea
| Platform | Status | Use |
|----------|--------|-----|
| **KakaoTalk** | **Universal** (95%+) | Messaging |
| **Instagram** | Dominant (youth) | Photos |
| **X (Twitter)** | Common | Discourse |
| **Naver (Blog/Cafe)** | Dominant (older) | Blogs/forums |
| **YouTube** | Universal | Video |
| **Band** | Niche | Group chat |
| **Tiktok** | Growing | Short videos |
| **Blind** | Niche | Workplace anon |

### China
| Platform | Status | Use |
|----------|--------|-----|
| **WeChat (微信)** | **Universal** (1.3B+) | Messaging, pay, social, work |
| **Weibo (微博)** | Dominant (Twitter-like) | News/discourse |
| **Douyin/TikTok (抖音)** | Dominant (short video) | Video (separate from TikTok international) |
| **Bilibili (B站)** | Young/ACGN | Video/anime |
| **Xiaohongshu (小红书)** | Growing (lifestyle) | Reviews |
| **Douban (豆瓣)** | Cultural reviews | Film/book/music |
| **QQ** | Older | Messaging |
| **Zhihu (知乎)** | Q&A | Knowledge |
| **YouTube/FB/X** | **Blocked** | (VPN required) |

---

## Digital Vocabulary Comparison
...
| Activity | English | Spanish | Japanese | Korean | Chinese |
|----------|---------|---------|----------|--------|---------|
...
## Emoji & Symbol Conventions

### Laughter

| Emoji | English | Spanish | Japanese | Korean | Chinese |
|-------|---------|---------|----------|--------|---------|
...
### Laughter Culture Note
- **English**: 😂 dominance
- **Spanish**: 😂 dominance
- **Japanese**: www (text) / "w" (leaned to side face) / "草" (kusa)
- **Korean**: ㅋㅋㅋ / ㅎㅎㅎ (Korean-specific consonants)
- **Chinese**: 2333 / 哈哈 / 「笑死」
...
| Country | Primary Search | Secondary | Notes |
|---------|----------------|-----------|-------|
| **US/UK/AU** | **Google** | Bing, DuckDuckGo | Google ~92% |
| **Spain** | **Google** | — | Google dominant |
| **LatAm** | **Google** | — | Google dominant |
| **Japan** | **Google** | Yahoo! Japan (legacy) | Yahoo JP still ~15% (Yahoo Auctions, mail) |
| **Korea** | **Naver** | Google (~10%) | **Naver dominant ~60%** |
| **China** | **Baidu** | Bing (CN), Sogou | **Google blocked**; Baidu ~75% |

---

## Internet Slang Acronyms Comparison
...
| Category | English | Spanish | Japanese | Korean | Chinese |
|----------|---------|---------|----------|--------|---------|
...
### E-Commerce Platforms by Country

| Country | Top Platform | 2nd | Notes |
|---------|--------------|-----|-------|
...
| **Japan** | Amazon JP, **Rakuten** | Yahoo Shopping, Mercari | Rakuten loyalty powerful |
| **Korea** | **Coupang**, Naver Smartstore, Gmarket, 11번가 | Auction, SSG | Coupang = rocket delivery |
| **China** | **Taobao (淘宝)**, **JD.com**, **Pinduoduo** | Tmall, Xiaohongshu, Douyin shop | Taobao = C2C; Tmall = B2C; Pinduoduo = discount |

---

## Streaming/Media

| Service | English | Spanish | Japan | Korea | China |
|---------|---------|---------|-------|-------|--------|
| **Music streaming** | Spotify, Apple Music | Spotify, Apple Music | **Apple Music** (dominant over Spotify), LINE Music | Melon, Genie, FLO, Bugs | NetEase Cloud Music (网易云音乐), QQ Music, KuGou |
...
| **Short video** | TikTok, YouTube Shorts | TikTok | TikTok | TikTok | **Douyin (抖音)** (separate from TikTok), Kuaishou (快手) |
...
## Tech Lingo: Common Loanwords/Acronyms
...
## Tech Company Local Equivalents

| Function | US | Spain | Japan | Korea | China |
|----------|----|----|----|----|----|
...
- `[[slang-colloquial]]` — digital slang overlap
- `[[dating-romance]]` — dating apps
- `[[shopping-money]]` — mobile pay systems
- `[[business-email]]` — email/Slack/Teams conventions
- `[[untranslatable-concepts]]` — *netatmo, nettle* metaphors
