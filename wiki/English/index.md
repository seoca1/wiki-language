...
- [[jp-travel-vocab]] - Japan Travel Vocab — English traveler's Japanese survival vocabulary

## Expressions

- [[common-phrases]] - English 핵심 일상 표현 (greeting/clarification/request/question) (5 theme files / 42 entries)
...
- All vocab theme files carry `Pipeline Form (machine-readable)` YAML appendix
  (schema reference: `wiki/pipeline-to-game.md` L33-39, L92)
- 7/13 batch: 244 new entries ingested from `raw/English/` (animals/business/clothing/emotions/food/nature)
- Game corpus citation: theme-anchor convention `[[{theme-file-stem}]]` only (no per-word pages)
...
See [[index]] for systematic EN/ES/JP/KR/CH comparisons. Especially relevant for English:

- [[politeness-honorifics]] — English lacks grammatical honorifics (relies on hedging + please/thank you)
- [[greetings]] — English has simplest greeting system (Hello/Hi); compare JP time-based, KR honorific-default
- [[pronouns-reference]] — English is unique in **requiring** subjects; compare pro-drop languages
- [[numbers-counters]] — English has **no** counter/classifier system (vs JP/KR/CH mandatory)
- [[tense-aspect-systems]] — English tense-light, aspect-simple vs JP/KR rich-aspect systems
- [[mood-systems]] — English modal auxiliaries (may/might/would) vs Spanish subjunctive
