...
# Literature Passages (English)

**Source:** [[literature-passages]]
**Theme:** Literature
**Level:** B1-B2 (Intermediate)

English vocabulary for literary genres, devices, famous authors and works, and literary analysis terms.
...
| English | Author |
|---------|--------|
| Romeo and Juliet | 셰익스피어 |
| Hamlet | 셰익스피어 |
| Pride and Prejudice | 오스틴 |
| Oliver Twist | 디킨스 |
| The Great Gatsby | 피츠제럴드 |
| Moby-Dick | 멜빌 |
| The Old Man and the Sea | 헤밍웨이 |
| War and Peace | 톨스토이 |
...
- 영국: Shakespeare = 영문학의 아버지
- 미국: 노벨문학상 수상자 다수 (Hemingway, Faulkner, Morrison 등)
- 한국 작가: 한강 (2024 노벨문학상) 등 세계적
- 영문학 읽기: 원서 읽기 + 번역서 읽기 병행

## Sources

- Cambridge English Vocabulary in Use
- Oxford Literature Guide

## Pronunciation Notes

| Pattern | Example | Korean Learner Tip |
|---------|---------|-------------------|
| th sound | theater, theme | Tongue between teeth → /θ/ |
| ch sound | character, chronicle | /tʃ/ sound |
| sh sound | shadow, shroud | /ʃ/ sound |
| schwa | author, character | Very short /ə/ |
| r sound | reader, literature | Tongue curled back → /ɹ/ |
